...
package.preload["fennel.repl"] = package.preload["fennel.repl"] or function(...)
  ...
  local function default_on_error(errtype, err)
    local function _707_()
      local _706_0 = errtype
      if (_706_0 == "Runtime") then
  ...
  local function splice_save_locals(env, lua_source, scope)
    ...
    local function _716_()
      local _714_0, _715_0 = lua_source:match("^(.*)[\n ](return .*)$")
      if ((nil ~= _714_0) and (nil ~= _715_0)) then
        local body = _714_0
        local _return = _715_0
  ...
  local function completer(env, scope, text, _3ffulltext, _from, _to)
    ...
    local function add_partials(input, tbl, prefix)
      ...
      for k, is_mangled in utils.allpairs(_718_()) do
    ...
    do
      local _727_0 = tostring((_3ffulltext or text)):match("^%s*,([^%s()[%]]*)$")
      if (nil ~= _727_0) then
        local cmd_fragment = _727_0
  ...
  local function reload(module_name, env, on_values, on_error)
    local _731_0, _732_0 = pcall(specials["load-code"]("return require(...)", env), module_name)
    if ((_731_0 == true) and (nil ~= _732_0)) then
      ...
      local new = nil
      do
        local _733_0, _734_0 = pcall(require, module_name)
        if ((_733_0 == true) and (nil ~= _734_0)) then
          local new0 = _734_0
          new = new0
        elseif (true and (nil ~= _734_0)) then
          local _0 = _733_0
          local msg = _734_0
          on_error("Repl", msg)
          new = old
    ...
    elseif ((_731_0 == false) and (nil ~= _732_0)) then
      ...
      elseif specials["macro-loaded"][module_name] then
        ...
        local function _739_()
          local _738_0 = msg:gsub("\n.*", "")
          return _738_0
        end
        return on_error("Runtime", _739_())
      end
    end
  end
  local function run_command(read, on_error, f)
    local _742_0, _743_0, _744_0 = pcall(read)
    if ((_742_0 == true) and (_743_0 == true) and (nil ~= _744_0)) then
      local val = _744_0
      local _745_0, _746_0 = pcall(f, val)
      if ((_745_0 == false) and (nil ~= _746_0)) then
        local msg = _746_0
        return on_error("Runtime", msg)
      end
    elseif (_742_0 == false) then
  ...
  commands.complete = function(env, read, on_values, on_error, scope, chars)
    ...
    return run_command(read, on_error, _750_)
  end
      ...
      if (("string" == type(name)) and (package ~= subtbl)) then
        ...
        elseif (_751_0 == "table") then
          if not seen[subtbl] then
            ...
            apropos_2a(pattern, subtbl, (prefix .. name:gsub("%.", "/") .. "."), _753_, names)
          end
        end
      end
    end
    ...
    for _, path in ipairs(apropos(".*")) do
      ...
      do
        ...
        if ("function" == type(tgt)) then
          local _761_0 = (compiler.metadata):get(tgt, "fnl/docstring")
          if (nil ~= _761_0) then
            local docstr = _761_0
  ...
  commands["apropos-show-docs"] = function(_env, read, on_values, on_error)
    ...
    return run_command(read, on_error, _767_)
  end
  ...
  local function resolve(identifier, _768_0, scope)
    local _769_ = _768_0
    local env = _769_
    local ___replLocals___ = _769_["___replLocals___"]
    local e = nil
    local function _770_(_241, _242)
      return (___replLocals___[scope.unmanglings[_242]] or env[_242])
    end
    e = setmetatable({}, {__index = _770_})
    local function _771_(...)
      local _772_0, _773_0 = ...
      if ((_772_0 == true) and (nil ~= _773_0)) then
        local code = _773_0
        local function _774_(...)
          local _775_0, _776_0 = ...
          if ((_775_0 == true) and (nil ~= _776_0)) then
            local val = _776_0
            return val
          else
            local _ = _775_0
        ...
        return _774_(pcall(specials["load-code"](code, e)))
      else
        local _ = _772_0
        return nil
      end
    end
    return _771_(pcall(compiler["compile-string"], tostring(identifier), {scope = scope}))
  end
  commands.find = function(env, read, on_values, on_error, scope)
    local function _779_(_241)
      local _780_0 = nil
      do
        local _781_0 = utils["sym?"](_241)
        if (nil ~= _781_0) then
          local _782_0 = resolve(_781_0, env, scope)
          if (nil ~= _782_0) then
            _780_0 = debug.getinfo(_782_0)
          else
            _780_0 = _782_0
          end
        else
      ...
      if ((_G.type(_780_0) == "table") and (nil ~= _780_0.linedefined) and (nil ~= _780_0.short_src) and (nil ~= _780_0.source) and (_780_0.what == "Lua")) then
        local line = _780_0.linedefined
        local src = _780_0.short_src
        local source = _780_0.source
        local fnlsrc = nil
        do
          local _785_0 = compiler.sourcemap
          if (nil ~= _785_0) then
            _785_0 = _785_0[source]
          end
          if (nil ~= _785_0) then
            _785_0 = _785_0[line]
          end
  ...
  commands.doc = function(env, read, on_values, on_error, scope)
    ...
    return run_command(read, on_error, _790_)
  end
  ...
  commands.compile = function(_, read, on_values, on_error, _0, _1, opts)
    local function _793_(_241)
      local _794_0, _795_0 = pcall(compiler.compile, _241, opts)
      if ((_794_0 == true) and (nil ~= _795_0)) then
        local result = _795_0
        return on_values({result})
      elseif (true and (nil ~= _795_0)) then
        local _2 = _794_0
        local msg = _795_0
        return on_error("Repl", ("Error compiling expression: " .. msg))
      end
    end
    return run_command(read, on_error, _793_)
  end
  ...
  local function load_plugin_commands(plugins)
    for i = #(plugins or {}), 1, -1 do
      for name, f in pairs(plugins[i]) do
        local _797_0 = name:match("^repl%-command%-(.*)")
        if (nil ~= _797_0) then
          local cmd_name = _797_0
          commands[cmd_name] = f
        end
      end
    end
  ...
  local function run_command_loop(input, read, loop, env, on_values, on_error, scope, chars, opts)
    ...
    do
      local _799_0 = commands[command_name]
      if (nil ~= _799_0) then
        local command = _799_0
  ...
  local function try_readline_21(opts, ok, readline)
    if ok then
      ...
      opts.readChunk = function(parser_state)
        local _804_0 = readline.readline(prompt_for((0 == parser_state["stack-size"])))
        if (nil ~= _804_0) then
          local input = _804_0
          return (input .. "\n")
        end
  ...
  local function repl(_3foptions)
    ...
    local _808_ = utils.copy(_3foptions)
    local opts = _808_
    local _3ffennelrc = _808_["fennelrc"]
    local _ = nil
    opts.fennelrc = nil
    _ = nil
    ...
    local function _810_(_241)
      return callbacks.readChunk(_241)
    end
    byte_stream, clear_stream = parser.granulate(_810_)
    local chars = {}
    local read, reset = nil, nil
    local function _811_(parser_state)
    ...
    read, reset = parser.parser(_811_)
    depth = (depth + 1)
    ...
    if opts.registerCompleter then
      local function _817_()
        local _816_0 = opts.scope
        local function _818_(...)
          return completer(env, _816_0, ...)
        end
        return _818_
      end
      opts.registerCompleter(_817_())
    end
      ...
      elseif command_3f(src_string) then
        ...
        if not_eof_3f then
          local function _822_(...)
            local _823_0, _824_0 = ...
            if ((_823_0 == true) and (nil ~= _824_0)) then
              local src = _824_0
              local function _825_(...)
                local _826_0, _827_0 = ...
                if ((_826_0 == true) and (nil ~= _827_0)) then
                  local chunk = _827_0
                  ...
                  return xpcall(_828_, _829_)
                elseif ((_826_0 == false) and (nil ~= _827_0)) then
                  local msg = _827_0
                  clear_stream()
              ...
              return _825_(_832_(...))
            elseif ((_823_0 == false) and (nil ~= _824_0)) then
              local msg = _824_0
              clear_stream()
              return callbacks.onError("Compile", msg)
            end
          ...
          _822_(pcall(compiler.compile, form, _834_()))
  ...
  local function _840_(overrides, _3fopts)
    return repl(utils.copy(_3fopts, utils.copy(overrides)))
  end
  return setmetatable({}, {__call = _840_, __index = {repl = repl}})
end
package.preload["fennel.specials"] = package.preload["fennel.specials"] or function(...)
  ...
  local function wrap_env(env)
    ...
    local function _480_(_, key, value)
      if utils["string?"](key) then
    ...
    local function _482_()
      ...
      do
        ...
        for k, v in utils.stablepairs(env) do
          ...
          if utils["string?"](k) then
            _484_ = compiler["global-unmangling"](k)
          else
            _484_ = k
          end
          k_15_, v_16_ = _484_, v
      ...
      return next, _483_, nil
    end
    return setmetatable({}, {__index = _478_, __newindex = _480_, __pairs = _482_})
  end
  ...
  local function current_global_names(_3fenv)
    local mt = nil
    do
      local _487_0 = getmetatable(_3fenv)
      if ((_G.type(_487_0) == "table") and (nil ~= _487_0.__pairs)) then
        local mtpairs = _487_0.__pairs
        local tbl_14_ = {}
  ...
  local function load_code(code, _3fenv, _3ffilename)
    ...
    local _492_0, _493_0 = rawget(_G, "setfenv"), rawget(_G, "loadstring")
    if ((nil ~= _492_0) and (nil ~= _493_0)) then
      local setfenv = _492_0
      local loadstring = _493_0
  ...
  local function doc_2a(tgt, name)
    ...
    if not tgt then
      ...
      local function _496_()
        local _495_0 = getmetatable(tgt)
        if ((_G.type(_495_0) == "table") and true) then
          local __call = _495_0.__call
          return ("function" == type(__call))
        end
      end
      if ((type(tgt) == "function") or _496_()) then
  ...
  local function compile_value(v)
    ...
    local chunk = {}
    local _506_ = compiler.compile1(v, scope, chunk, opts)
    local _507_ = _506_[1]
    local v0 = _507_[1]
    return v0
  end
  ...
  local function get_fn_name(ast, scope, fn_name, multi)
    if (fn_name and (fn_name[1] ~= "nil")) then
      local _513_
      if not multi then
        _513_ = compiler["declare-local"](fn_name, scope, ast)
      else
        _513_ = compiler["symbol-to-expression"](fn_name, scope)[1]
      end
      return _513_, not multi, 3
    else
      return nil, true, 2
    end
  end
  local function compile_named_fn(ast, f_scope, f_chunk, parent, index, fn_name, local_3f, arg_name_list, f_metadata)
    ...
    local _516_
    if local_3f then
      _516_ = "local function %s(%s)"
    else
      _516_ = "%s = function(%s)"
    end
    compiler.emit(parent, string.format(_516_, fn_name, table.concat(arg_name_list, ", ")), ast)
  ...
  local function get_function_metadata(ast, arg_list, index)
    local function _519_(_241, _242)
      local tbl_14_ = _241
    ...
    local function _521_(_241, _242)
      _241["fnl/docstring"] = _242
      return _241
    end
    return maybe_metadata(ast, utils["kv-table?"], _519_, maybe_metadata(ast, utils["string?"], _521_, {["fnl/arglist"] = arg_list}, index))
  end
  SPECIALS.fn = function(ast, scope, parent, opts)
    local f_scope = nil
    do
      local _522_0 = compiler["make-scope"](scope)
      _522_0["vararg"] = false
      f_scope = _522_0
    end
    local f_chunk = {}
  ...
  SPECIALS.lua = function(ast, _, parent)
    ...
    local _532_
    do
      local _531_0 = utils["sym?"](ast[3])
      if (nil ~= _531_0) then
        _532_ = tostring(_531_0)
      else
        _532_ = _531_0
      end
    end
  ...
  local function dot(ast, scope, parent)
    ...
    local _535_ = compiler.compile1(lhs_node, scope, parent, {nval = 1})
    local lhs = _535_[1]
    if (len == 2) then
      return tostring(lhs)
    else
      ...
      for i = 3, len do
        ...
        if (utils["string?"](index) and utils["valid-lua-identifier?"](index)) then
          ...
          local _536_ = compiler.compile1(index, scope, parent, {nval = 1})
          local index0 = _536_[1]
  ...
  SPECIALS.let = function(_543_0, scope, parent, opts)
    local _544_ = _543_0
    local _ = _544_[1]
    local bindings = _544_[2]
    local ast = _544_
  ...
  local function if_2a(ast, scope, parent, opts)
    ...
    if (#ast == 2) then
      ...
      for i = 2, (#ast - 1), 2 do
        local condchunk = {}
        local _553_ = compiler.compile1(ast[i], do_scope, condchunk, {nval = 1})
        local cond = _553_[1]
  ...
  local function remove_until_condition(bindings, ast)
    ...
    for i = (#bindings - 1), 3, -1 do
      local _559_0 = clause_3f(bindings[i])
      if ((_559_0 == false) or (_559_0 == nil)) then
      elseif (nil ~= _559_0) then
        local clause = _559_0
  ...
  local function compile_until(_3fcondition, scope, chunk)
    if _3fcondition then
      local _561_ = compiler.compile1(_3fcondition, scope, chunk, {nval = 1})
      local condition_lua = _561_[1]
  ...
  local function method_call(ast, scope, parent)
    ...
    local _572_ = compiler.compile1(ast[2], scope, parent, {nval = 1})
    local target = _572_[1]
    local args = {}
    for i = 4, #ast do
      local subexprs = nil
      local _573_
      ...
      subexprs = compiler.compile1(ast[i], scope, parent, {nval = _573_})
      local tbl_17_ = args
      local i_18_ = #tbl_17_
    ...
    local _576_0 = method_special_type(ast)
    if (_576_0 == "native") then
      return native_method_call(ast, scope, parent, target, args)
    elseif (_576_0 == "nonnative") then
      return nonnative_method_call(ast, scope, parent, target, args)
    elseif (_576_0 == "binding") then
  ...
  SPECIALS.hashfn = function(ast, scope, parent)
    ...
    local f_scope = nil
    do
      local _583_0 = compiler["make-scope"](scope)
      _583_0["vararg"] = false
      _583_0["hashfn"] = true
      f_scope = _583_0
    end
  ...
  local function short_circuit_safe_3f(x, scope)
    ...
    elseif utils["list?"](x) then
      if utils["sym?"](x[1]) then
        local _589_0 = str1(x)
        if ((_589_0 == "fn") or (_589_0 == "hashfn") or (_589_0 == "let") or (_589_0 == "local") or (_589_0 == "var") or (_589_0 == "set") or (_589_0 == "tset") or (_589_0 == "if") or (_589_0 == "each") or (_589_0 == "for") or (_589_0 == "while") or (_589_0 == "do") or (_589_0 == "lua") or (_589_0 == "global")) then
          return false
        elseif (((_589_0 == "<") or (_589_0 == ">") or (_589_0 == "<=") or (_589_0 == ">=") or (_589_0 == "=") or (_589_0 == "not=") or (_589_0 == "~=")) and (comparator_special_type(x) == "binding")) then
          return false
        else
          local function _590_()
            return (1 ~= x[2])
          end
          if ((_589_0 == "pick-values") and _590_()) then
            return false
          else
  ...
  local function emit_short_circuit_if(ast, scope, parent, name, subast, accumulator, expr_string, setter)
    ...
    compiler.emit(parent, ("if %s then"):format(_601_()), subast)
    do
      local chunk = {}
  ...
  local function define_arithmetic_special(name, zero_arity, unary_prefix, _3flua_name)
    local _607_
    do
      local _606_0 = (_3flua_name or name)
      local function _608_(...)
        return operator_special(_606_0, zero_arity, unary_prefix, ...)
      end
      _607_ = _608_
    end
    SPECIALS[name] = _607_
  ...
  local function bitop_special(native_name, lib_name, zero_arity, unary_prefix, ast, scope, parent)
    if (#ast == 1) then
      ...
      for i = 2, len do
        ...
        subexprs = compiler.compile1(ast[i], scope, parent, {nval = _609_})
  ...
  SPECIALS.bnot = function(ast, scope, parent)
    compiler.assert((#ast == 2), "expected one argument", ast)
    local _617_ = compiler.compile1(ast[2], scope, parent, {nval = 1})
    local value = _617_[1]
    if utils.root.options.useBitLib then
  ...
  local function native_comparator(op, _619_0, scope, parent)
    local _620_ = _619_0
    local _ = _620_[1]
    local lhs_ast = _620_[2]
    local rhs_ast = _620_[3]
    local _621_ = compiler.compile1(lhs_ast, scope, parent, {nval = 1})
    local lhs = _621_[1]
    local _622_ = compiler.compile1(rhs_ast, scope, parent, {nval = 1})
    local rhs = _622_[1]
  ...
  local function binding_comparator(op, chain_op, ast, scope, parent)
    ...
    return ("(" .. table.concat(_626_, chain) .. ")")
  end
  local function define_comparator_special(name, _3flua_op, _3fchain_op)
    do
      ...
      local function opfn(ast, scope, parent)
        ...
        local _628_0 = comparator_special_type(ast)
        if (_628_0 == "native") then
          return native_comparator(op, ast, scope, parent)
        elseif (_628_0 == "idempotent") then
          return idempotent_comparator(op, _3fchain_op, ast, scope, parent)
        elseif (_628_0 == "binding") then
  ...
  local function make_compiler_env(ast, scope, parent, _3fopts)
    local provided = nil
    do
      local _635_0 = (_3fopts or utils.root.options)
      if ((_G.type(_635_0) == "table") and (_635_0["compiler-env"] == "strict")) then
        provided = safe_compiler_env()
      elseif ((_G.type(_635_0) == "table") and (nil ~= _635_0.compilerEnv)) then
        local compilerEnv = _635_0.compilerEnv
        provided = compilerEnv
      elseif ((_G.type(_635_0) == "table") and (nil ~= _635_0["compiler-env"])) then
        local compiler_env = _635_0["compiler-env"]
    ...
    local function _638_(symbol)
      compiler.assert(compiler.scopes.macro, "must call from macro", ast)
      return compiler.scopes.macro.manglings[tostring(symbol)]
    end
    local function _639_(base)
      return utils.sym(compiler.gensym((compiler.scopes.macro or scope), base))
    end
    local function _640_(form)
      compiler.assert(compiler.scopes.macro, "must call from macro", ast)
      return compiler.macroexpand(form, compiler.scopes.macro)
    end
    env = {["assert-compile"] = compiler.assert, ["ast-source"] = utils["ast-source"], ["comment?"] = utils["comment?"], ["fennel-module-name"] = fennel_module_name, ["get-scope"] = _637_, ["in-scope?"] = _638_, ["list?"] = utils["list?"], ["macro-loaded"] = macro_loaded, ["multi-sym?"] = utils["multi-sym?"], ["sequence?"] = utils["sequence?"], ["sym?"] = utils["sym?"], ["table?"] = utils["table?"], ["varg?"] = utils["varg?"], _AST = ast, _CHUNK = parent, _IS_COMPILER = true, _SCOPE = scope, _SPECIALS = compiler.scopes.global.specials, _VARARG = utils.varg(), comment = utils.comment, gensym = _639_, list = utils.list, macroexpand = _640_, sequence = utils.sequence, sym = utils.sym, unpack = unpack, version = utils.version, view = view}
    env._G = env
  ...
  local _643_ = _641_(...)
  local dirsep = _643_[1]
  local pathsep = _643_[2]
  local pathmark = _643_[3]
  ...
  local function search_module(modulename, _3fpathstring)
    ...
    local function try_path(path)
      ...
      local _644_0 = (io.open(filename) or io.open(filename2))
      if (nil ~= _644_0) then
        local file = _644_0
        file:close()
        return filename
    ...
    local function find_in_path(start, _3ftried_paths)
      local _646_0 = fullpath:match(pattern, start)
      if (nil ~= _646_0) then
        local path = _646_0
        local _647_0, _648_0 = try_path(path)
        if (nil ~= _647_0) then
          local filename = _647_0
          return filename
        elseif ((_647_0 == nil) and (nil ~= _648_0)) then
          local error = _648_0
          local function _650_()
            local _649_0 = (_3ftried_paths or {})
            table.insert(_649_0, error)
            return _649_0
          end
          return find_in_path((start + #path + 1), _650_())
        end
      else
        local _ = _646_0
  ...
  local function make_searcher(_3foptions)
    local function _655_(module_name)
      local opts = utils.copy(utils.root.options)
      for k, v in pairs((_3foptions or {})) do
        opts[k] = v
      end
      opts["module-name"] = module_name
      local _656_0, _657_0 = search_module(module_name)
      if (nil ~= _656_0) then
        local filename = _656_0
        local function _658_(...)
          return utils["fennel-module"].dofile(filename, opts, ...)
        end
        return _658_, filename
      elseif ((_656_0 == nil) and (nil ~= _657_0)) then
        local error = _657_0
        return error
      end
    end
  ...
  local function fennel_macro_searcher(module_name)
    local opts = nil
    do
      local _660_0 = utils.copy(utils.root.options)
      _660_0["module-name"] = module_name
      _660_0["env"] = "_COMPILER"
      _660_0["requireAsInclude"] = false
      _660_0["allowedGlobals"] = nil
      opts = _660_0
    end
    local _661_0 = search_module(module_name, utils["fennel-module"]["macro-path"])
    if (nil ~= _661_0) then
      local filename = _661_0
      local _662_
      ...
      return _662_, filename
    end
  end
  local function lua_macro_searcher(module_name)
    local _667_0 = search_module(module_name, package.path)
    if (nil ~= _667_0) then
      ...
      do
        ...
        code = close_handlers_10_(_G.xpcall(_669_, (package.loaded.fennel or debug).traceback))
      end
  ...
  local function search_macro_module(modname, n)
    local _671_0 = macro_searchers[n]
    if (nil ~= _671_0) then
      local f = _671_0
      local _672_0, _673_0 = f(modname)
      if ((nil ~= _672_0) and true) then
        local loader = _672_0
        local _3ffilename = _673_0
  ...
  local function sandbox_fennel_module(modname)
    if ((modname == "fennel.macros") or (package and package.loaded and ("table" == type(package.loaded[modname])) and (package.loaded[modname].metadata == compiler.metadata))) then
      local function _676_(_, ...)
        return (compiler.metadata):setall(...)
      end
      return {metadata = {setall = _676_}, view = view}
    end
  end
  local function _678_(modname)
    ...
    return (macro_loaded[modname] or sandbox_fennel_module(modname) or _679_())
  end
  safe_require = _678_
  ...
  local function resolve_module_name(_680_0, _scope, _parent, opts)
    local _681_ = _680_0
    local second = _681_[2]
    local filename = _681_["filename"]
  ...
  local function include_path(ast, opts, path, mod, fennel_3f)
    ...
    do
      ...
      src = close_handlers_10_(_G.xpcall(_687_, (package.loaded.fennel or debug).traceback))
    end
  ...
  SPECIALS.include = function(ast, scope, parent, opts)
    ...
    local modexpr = nil
    do
      local _690_0, _691_0 = pcall(resolve_module_name, ast, scope, parent, opts)
      if ((_690_0 == true) and (nil ~= _691_0)) then
        local modname = _691_0
    ...
    if ((modexpr.type ~= "literal") or ((modexpr[1]):byte() ~= 34)) then
      ...
      local function _695_()
        local _694_0 = search_module(mod)
        if (nil ~= _694_0) then
          local fennel_path = _694_0
      ...
      res = ((utils["member?"](mod, (utils.root.options.skipInclude or {})) and opts.fallback(modexpr, true)) or include_circular_fallback(mod, modexpr, opts.fallback, ast) or utils.root.scope.includes[mod] or _695_())
  ...
  SPECIALS["pick-values"] = function(ast, scope, parent)
    ...
    if (1 == n) then
      local _699_ = compiler.compile1(vals, scope, parent, {nval = 1})
      local _700_ = _699_[1]
      local expr = _700_[1]
      return {("(" .. expr .. ")")}
    elseif (0 == n) then
...
package.preload["fennel.compiler"] = package.preload["fennel.compiler"] or function(...)
  ...
  local function assert_compile(condition, msg, ast, _3ffallback_ast)
    if not condition then
      local _277_ = (utils.root.options or {})
      local error_pinpoint = _277_["error-pinpoint"]
      local source = _277_["source"]
      local unfriendly = _277_["unfriendly"]
      local ast0 = nil
  ...
  local function global_mangling(str)
    if utils["valid-lua-identifier?"](str) then
      ...
      local _284_
      do
        local _283_0 = utils.root.options
        if (nil ~= _283_0) then
          _283_0 = _283_0["global-mangle"]
        end
        _284_ = _283_0
      end
      if (_284_ == false) then
        ...
        return ("__fnl_global__" .. str:gsub("[^%w]", _286_))
      end
    end
  end
  local function global_unmangling(identifier)
    local _288_0 = string.match(identifier, "^__fnl_global__(.*)$")
    if (nil ~= _288_0) then
      local rest = _288_0
      local _289_0 = nil
      ...
      _289_0 = rest:gsub("_[%da-f][%da-f]", _290_)
      return _289_0
    else
      local _ = _288_0
      return identifier
  ...
  local function autogensym(base, scope)
    local _298_0 = utils["multi-sym?"](base)
    if (nil ~= _298_0) then
      local parts = _298_0
      ...
      return (scope.autogensyms[base] or _299_())
    end
  end
  ...
  local function declare_local(symbol, scope, ast, _3fvar_3f, _3fdeferred_scope_changes)
    ...
    mangling = string.gsub(string.gsub(raw, "-", "_"), "[^%w_]", _304_)
  ...
  local function symbol_to_expression(symbol, scope, _3freference_3f)
    ...
    local function _309_()
      local _308_0 = utils.root.options
      if (nil ~= _308_0) then
        _308_0 = _308_0.allowedGlobals
      end
      return _308_0
    end
    if (_309_() and not local_3f and scope.parent) then
  ...
  local function flatten_chunk(file_sourcemap, chunk, tab, depth)
    if chunk.leaf then
      local _319_ = utils["ast-source"](chunk.ast)
      local endline = _319_["endline"]
      ...
      do
        ...
        if (_321_0 == true) then
          tab0 = "  "
        elseif (_321_0 == false) then
          tab0 = ""
        elseif (nil ~= _321_0) then
          local tab1 = _321_0
          tab0 = tab1
        elseif (_321_0 == nil) then
          tab0 = ""
        else
        tab0 = nil
        end
  ...
  local function make_metadata()
    local function _331_(self, tgt, _3fkey)
      if self[tgt] then
        if (nil ~= _3fkey) then
    ...
    local function _334_(self, tgt, key, value)
      self[tgt] = (self[tgt] or {})
      self[tgt][key] = value
      return tgt
    end
    local function _335_(self, tgt, ...)
      local kv_len = select("#", ...)
      local kvs = {...}
      if ((kv_len % 2) ~= 0) then
    ...
    return setmetatable({}, {__index = {get = _331_, set = _334_, setall = _335_}, __mode = "k"})
  end
  ...
  local function handle_compile_opts(exprs, parent, opts, ast)
    ...
    if opts.target then
      ...
      emit(parent, string.format("%s = %s", opts.target, _345_()), ast)
    end
  ...
  local function find_macro(ast, scope)
    local macro_2a = nil
    do
      local _348_0 = utils["sym?"](ast[1])
      if (_348_0 ~= nil) then
        local _349_0 = tostring(_348_0)
        if (_349_0 ~= nil) then
          macro_2a = scope.macros[_349_0]
        else
          macro_2a = _349_0
        end
      else
  ...
  local function propagate_trace_info(_353_0, _index, node)
    local _354_ = _353_0
    local byteend = _354_["byteend"]
    local bytestart = _354_["bytestart"]
    local filename = _354_["filename"]
    local line = _354_["line"]
    do
  ...
  local function macroexpand_2a(ast, scope, _3fonce)
    ...
    if utils["list?"](ast) then
      _359_0 = find_macro(ast, scope)
    else
    _359_0 = nil
    end
    if (_359_0 == false) then
      return ast
    elseif (nil ~= _359_0) then
      local macro_2a = _359_0
  ...
  local function callable_3f(_369_0, ctype, callee)
    local _370_ = _369_0
    local call_ast = _370_[1]
  ...
  local function compile_function_call(ast, scope, parent, opts, compile1, len)
    local _372_ = compile1(ast[1], scope, parent, {nval = 1})[1]
    local callee = _372_[1]
    local ctype = _372_["type"]
    local fargs = {}
    ...
    for i = 2, len do
      ...
      subexprs = compile1(ast[i], scope, parent, {nval = _373_})
  ...
  local function compile_varg(ast, scope, parent, opts)
    ...
    if scope.hashfn then
      ...
      _378_ = "unexpected vararg"
    end
    assert_compile(scope.vararg, _378_, ast)
  ...
  do
    ...
    view_opts = {["negative-infinity"] = "(-1/0)", ["negative-nan"] = _381_, infinity = "(1/0)", nan = _383_}
  end
  local function compile_scalar(ast, _scope, parent, opts)
    local compiled = nil
    do
      local _385_0 = type(ast)
      if (_385_0 == "nil") then
        compiled = "nil"
      elseif (_385_0 == "boolean") then
        compiled = tostring(ast)
      elseif (_385_0 == "string") then
        compiled = serialize_string(ast)
      elseif (_385_0 == "number") then
  ...
  local function compile_table(ast, scope, parent, opts, compile1)
    local function escape_key(k)
      if ((type(k) == "string") and utils["valid-lua-identifier?"](k)) then
        ...
        local _387_ = compile1(k, scope, parent, {nval = 1})
        local compiled = _387_[1]
    ...
    do
      ...
      for k in utils.stablepairs(ast) do
        local val_19_ = nil
        if not keys[k] then
          local _390_ = compile1(ast[k], scope, parent, {nval = 1})
          local v = _390_[1]
  ...
  local function destructure(to, from, ast, scope, parent, opts)
    local opts0 = (opts or {})
    local _394_ = opts0
    local declaration = _394_["declaration"]
    local forceglobal = _394_["forceglobal"]
    local forceset = _394_["forceset"]
    local isvar = _394_["isvar"]
    local symtype = _394_["symtype"]
    ...
    local function getname(symbol, ast0)
      ...
      if declaration then
        ...
        if forceglobal then
          ...
          local _399_
          do
            local _398_0 = utils.root.options
            if (nil ~= _398_0) then
              _398_0 = _398_0.allowedGlobals
            end
            _399_ = _398_0
          end
          if _399_ then
            local _402_
            do
              local _401_0 = utils.root.options
              if (nil ~= _401_0) then
                _401_0 = _401_0.allowedGlobals
              end
              _402_ = _401_0
            end
            table.insert(_402_, raw)
          end
        end
    ...
    local function dynamic_set_target(_413_0)
      local _414_ = _413_0
      local _ = _414_[1]
      local target = _414_[2]
      local keys = {(table.unpack or unpack)(_414_, 3)}
    ...
    local function destructure_kv_rest(s, v, left, excluded_keys, destructure1)
      ...
      exclude_str = table.concat(_419_, ", ")
    ...
    local function destructure_rest(s, k, left, destructure1)
      ...
      assert_compile((utils["sequence?"](left) and _421_()), "expected rest argument before last parameter", left)
    ...
    local function optimize_table_destructure_3f(left, right)
      ...
      return (utils["sequence?"](left) and utils["sequence?"](right) and _422_())
    end
    local function destructure_table(left, rightexprs, top_3f, destructure1, up1)
      if optimize_table_destructure_3f(left, rightexprs) then
        ...
        do
          local _423_0 = nil
          if top_3f then
            _423_0 = exprs1(compile1(from, scope, parent))
          else
            _423_0 = exprs1(rightexprs)
          end
          if (_423_0 == "") then
            right = "nil"
  ...
  local function compile_asts(asts, options)
    ...
    local _438_ = utils.root
    _438_["set-reset"](_438_)
  ...
  local function compile(from, _3fopts)
    local _441_0 = type(from)
    if (_441_0 == "userdata") then
      local function _442_()
        local _443_0 = from:read(1)
        if (nil ~= _443_0) then
          return _443_0:byte()
        else
          return _443_0
      ...
      return compile_stream(_442_, _3fopts)
    elseif (_441_0 == "function") then
  ...
  local function traceback_frame(info)
    ...
    elseif (info.what == "C") then
      ...
      if (info.what == "Lua") then
        ...
        return string.format("\9%s:%d: in function %s", info.short_src, info.currentline, _448_())
  ...
  local function traceback(_3fmsg, _3fstart)
    local _451_0 = type(_3fmsg)
    if ((_451_0 == "nil") or (_451_0 == "string")) then
      local msg = (_3fmsg or "")
      if ((msg:find("^%g+:%d+:%d+ Compile error:.*") or msg:find("^%g+:%d+:%d+ Parse error:.*")) and not utils["debug-on?"]("trace")) then
        ...
        while not done_3f do
          do
            local _453_0 = lua_getinfo(level, "Sln")
            if (_453_0 == nil) then
              done_3f = true
            elseif (nil ~= _453_0) then
              local info = _453_0
  ...
  local function do_quote(form, scope, parent, runtime_3f)
    ...
    elseif utils["sequence?"](form) then
      ...
      return string.format("setmetatable({%s}, {filename=%s, line=%s, sequence=%s})", mixed_concat(mapped, ", "), filename, _473_, "(getmetatable(_G.sequence()))['sequence']")
    elseif (type(form) == "table") then
      ...
      return string.format("setmetatable({%s}, {filename=%s, line=%s})", mixed_concat(mapped, ", "), filename, _476_())
...
package.preload["fennel.parser"] = package.preload["fennel.parser"] or function(...)
  ...
  local function parser_fn(getbyte, filename, _214_0)
    local _215_ = _214_0
    local options = _215_
    local comments = _215_["comments"]
    local source = _215_["source"]
    local unfriendly = _215_["unfriendly"]
    local stack = {}
    ...
    local function whitespace_3f(b)
      local function _223_()
        local _222_0 = options.whitespace
        if (nil ~= _222_0) then
          _222_0 = _222_0[b]
        end
        return _222_0
      end
      return ((b == 32) or ((9 <= b) and (b <= 13)) or _223_())
    end
    ...
    local function parse_stream()
      ...
      local function dispatch(v, _3fsource, _3fraw)
        ...
        local v0 = nil
        do
          local _227_0 = utils["hook-opts"]("parse-form", options, v, _3fsource, _3fraw, stack)
          if (nil ~= _227_0) then
            local hookv = _227_0
            v0 = hookv
          else
        ...
        local _229_0 = stack[#stack]
        if (_229_0 == nil) then
          retval, done_3f = v0, true
          return nil
        elseif ((_G.type(_229_0) == "table") and (nil ~= _229_0.prefix)) then
          local prefix = _229_0.prefix
          local source0 = nil
          do
            local _230_0 = table.remove(stack)
            set_source_fields(_230_0)
            source0 = _230_0
          end
          local list = utils.list(utils.sym(prefix, source0), v0)
          return dispatch(utils.copy(source0, list))
        elseif (nil ~= _229_0) then
          local top = _229_0
      ...
      local function badend()
        ...
        do
          local tbl_17_ = {}
          local i_18_ = #tbl_17_
          for _, _232_0 in ipairs(stack) do
            local _233_ = _232_0
            local closer = _233_["closer"]
        ...
        return parse_error(string.format("expected closing delimiter%s %s", _235_, string.char(unpack(closers))), 0)
      end
      ...
      local function parse_comment(b, contents)
        if (b and (10 ~= b)) then
          ...
          return parse_comment(getb(), _238_())
      ...
      local function add_comment_at(comments0, index, node)
        local _242_0 = comments0[index]
        if (nil ~= _242_0) then
          local existing = _242_0
      ...
      local function parse_string_loop(chars, b, state)
        ...
        local state0 = nil
        do
          local _253_0 = {state, b}
          if ((_G.type(_253_0) == "table") and (_253_0[1] == "base") and (_253_0[2] == 92)) then
            state0 = "backslash"
          elseif ((_G.type(_253_0) == "table") and (_253_0[1] == "base") and (_253_0[2] == 34)) then
            state0 = "done"
          elseif ((_G.type(_253_0) == "table") and (_253_0[1] == "backslash") and (_253_0[2] == 10)) then
      ...
      local function parse_string(source0)
        ...
        local _258_0 = (rawget(_G, "loadstring") or load)(("return " .. formatted))
        if (nil ~= _258_0) then
          local load_fn = _258_0
          return dispatch(load_fn(), source0, raw)
        elseif (_258_0 == nil) then
...
local function eval(str, _3foptions, ...)
  ...
  loader = specials["load-code"](lua_source, env, _846_(...))
  opts.filename = nil
  return loader(...)
end
...
local function syntax()
  ...
  for k, v in pairs(_G) do
    local _847_0 = type(v)
    if (_847_0 == "function") then
      out[k] = {["function?"] = true, ["global?"] = true}
    elseif (_847_0 == "table") then
...
do
  ...
  local function __3f_3e_2a(val, _3fe, ...)
    ...
    elseif not utils["idempotent-expr?"](val) then
      return setmetatable({filename=nil, line=40, bytestart=1174, sym('let', nil, {quoted=true, filename=nil, line=40}), setmetatable({sym('tmp_3_', nil, {filename=nil, line=40}), val}, {filename=nil, line=40}), setmetatable({filename=nil, line=41, bytestart=1199, sym('-?>', nil, {quoted=true, filename=nil, line=41}), sym('tmp_3_', nil, {filename=nil, line=41}), _3fe, ...}, getmetatable(list()))}, getmetatable(list()))
    else
      local call = nil
      ...
      return setmetatable({filename=nil, line=44, bytestart=1317, sym('if', nil, {quoted=true, filename=nil, line=44}), setmetatable({filename=nil, line=44, bytestart=1321, sym('not=', nil, {quoted=true, filename=nil, line=44}), sym('nil', nil, {quoted=true, filename=nil, line=44}), val}, getmetatable(list())), __3f_3e_2a(call, ...)}, getmetatable(list()))
    end
  end
  ...
  local function __3f_3e_3e_2a(val, _3fe, ...)
    if (nil == _3fe) then
      return val
    elseif not utils["idempotent-expr?"](val) then
      return setmetatable({filename=nil, line=54, bytestart=1627, sym('let', nil, {quoted=true, filename=nil, line=54}), setmetatable({sym('tmp_6_', nil, {filename=nil, line=54}), val}, {filename=nil, line=54}), setmetatable({filename=nil, line=55, bytestart=1652, sym('-?>>', nil, {quoted=true, filename=nil, line=55}), sym('tmp_6_', nil, {filename=nil, line=55}), _3fe, ...}, getmetatable(list()))}, getmetatable(list()))
    else
      local call = nil
      if _G["list?"](_3fe) then
        call = copy(_3fe)
      ...
      return setmetatable({filename=nil, line=58, bytestart=1769, sym('if', nil, {quoted=true, filename=nil, line=58}), setmetatable({filename=nil, line=58, bytestart=1773, sym('not=', nil, {quoted=true, filename=nil, line=58}), val, sym('nil', nil, {quoted=true, filename=nil, line=58})}, getmetatable(list())), __3f_3e_3e_2a(call, ...)}, getmetatable(list()))
    end
  end
  ...
  local function _3fdot(tbl, ...)
    local head = gensym("t")
    local lookups = setmetatable({filename=nil, line=66, bytestart=2024, sym('do', nil, {quoted=true, filename=nil, line=66}), setmetatable({filename=nil, line=67, bytestart=2047, sym('var', nil, {quoted=true, filename=nil, line=67}), head, tbl}, getmetatable(list())), head}, getmetatable(list()))
    for i, k in ipairs({...}) do
      table.insert(lookups, (i + 2), setmetatable({filename=nil, line=73, bytestart=2335, sym('if', nil, {quoted=true, filename=nil, line=73}), setmetatable({filename=nil, line=73, bytestart=2339, sym('not=', nil, {quoted=true, filename=nil, line=73}), sym('nil', nil, {quoted=true, filename=nil, line=73}), head}, getmetatable(list())), setmetatable({filename=nil, line=73, bytestart=2356, sym('set', nil, {quoted=true, filename=nil, line=73}), head, setmetatable({filename=nil, line=73, bytestart=2367, sym('.', nil, {quoted=true, filename=nil, line=73}), head, k}, getmetatable(list()))}, getmetatable(list()))}, getmetatable(list())))
    end
    return lookups
  end
  ...
  local function doto_2a(val, ...)
    ...
    if not utils["idempotent-expr?"](val) then
      return setmetatable({filename=nil, line=80, bytestart=2585, sym('let', nil, {quoted=true, filename=nil, line=80}), setmetatable({sym('tmp_9_', nil, {filename=nil, line=80}), val}, {filename=nil, line=80}), setmetatable({filename=nil, line=81, bytestart=2609, sym('doto', nil, {quoted=true, filename=nil, line=81}), sym('tmp_9_', nil, {filename=nil, line=81}), ...}, getmetatable(list()))}, getmetatable(list()))
    else
      local form = setmetatable({filename=nil, line=82, bytestart=2643, sym('do', nil, {quoted=true, filename=nil, line=82})}, getmetatable(list()))
  ...
  local function when_2a(condition, body1, ...)
    ...
    return setmetatable({filename=nil, line=93, bytestart=2992, sym('if', nil, {quoted=true, filename=nil, line=93}), condition, setmetatable({filename=nil, line=94, bytestart=3014, sym('do', nil, {quoted=true, filename=nil, line=94}), body1, ...}, getmetatable(list()))}, getmetatable(list()))
  end
  ...
  local function with_open_2a(closable_bindings, ...)
    local bodyfn = setmetatable({filename=nil, line=102, bytestart=3312, sym('fn', nil, {quoted=true, filename=nil, line=102}), setmetatable({}, {filename=nil, line=102}), ...}, getmetatable(list()))
    local closer = setmetatable({filename=nil, line=104, bytestart=3359, sym('fn', nil, {quoted=true, filename=nil, line=104}), sym('close-handlers_12_', nil, {filename=nil, line=104}), setmetatable({sym('ok_13_', nil, {filename=nil, line=104}), _VARARG}, {filename=nil, line=104}), setmetatable({filename=nil, line=105, bytestart=3407, sym('if', nil, {quoted=true, filename=nil, line=105}), sym('ok_13_', nil, {filename=nil, line=105}), _VARARG, setmetatable({filename=nil, line=105, bytestart=3419, sym('error', nil, {quoted=true, filename=nil, line=105}), _VARARG, 0}, getmetatable(list()))}, getmetatable(list()))}, getmetatable(list()))
    local traceback = setmetatable({filename=nil, line=106, bytestart=3454, sym('.', nil, {quoted=true, filename=nil, line=106}), setmetatable({filename=nil, line=106, bytestart=3457, sym('or', nil, {quoted=true, filename=nil, line=106}), setmetatable({filename=nil, line=106, bytestart=3461, sym('?.', nil, {quoted=true, filename=nil, line=106}), sym('_G', nil, {quoted=true, filename=nil, line=106}), "package", "loaded", _G["fennel-module-name"]()}, getmetatable(list())), sym('_G.debug', nil, {quoted=true, filename=nil, line=107}), setmetatable({["traceback"]=setmetatable({filename=nil, line=nil, bytestart=nil, sym('hashfn', nil, {quoted=true, filename=nil, line=nil}), ""}, getmetatable(list()))}, {filename=nil, line=107})}, getmetatable(list())), "traceback"}, getmetatable(list()))
    for i = 1, #closable_bindings, 2 do
      assert(_G["sym?"](closable_bindings[i]), "with-open only allows symbols in bindings")
      table.insert(closer, 4, setmetatable({filename=nil, line=111, bytestart=3752, sym(':', nil, {quoted=true, filename=nil, line=111}), closable_bindings[i], "close"}, getmetatable(list())))
    end
    return setmetatable({filename=nil, line=112, bytestart=3795, sym('let', nil, {quoted=true, filename=nil, line=112}), closable_bindings, closer, setmetatable({filename=nil, line=114, bytestart=3841, sym('close-handlers_12_', nil, {filename=nil, line=114}), setmetatable({filename=nil, line=114, bytestart=3858, sym('_G.xpcall', nil, {quoted=true, filename=nil, line=114}), bodyfn, traceback}, getmetatable(list()))}, getmetatable(list()))}, getmetatable(list()))
  end
  ...
  local function collect_2a(iter_tbl, key_expr, value_expr, ...)
    ...
    if (nil == value_expr) then
      ...
      kv_expr = setmetatable({filename=nil, line=151, bytestart=5514, sym('values', nil, {quoted=true, filename=nil, line=151}), key_expr, value_expr}, getmetatable(list()))
    end
    local into, iter = extract_into(iter_tbl)
    return setmetatable({filename=nil, line=153, bytestart=5596, sym('let', nil, {quoted=true, filename=nil, line=153}), setmetatable({sym('tbl_16_', nil, {filename=nil, line=153}), into}, {filename=nil, line=153}), setmetatable({filename=nil, line=154, bytestart=5621, sym('each', nil, {quoted=true, filename=nil, line=154}), iter, setmetatable({filename=nil, line=155, bytestart=5642, sym('let', nil, {quoted=true, filename=nil, line=155}), setmetatable({setmetatable({filename=nil, line=155, bytestart=5648, sym('k_17_', nil, {filename=nil, line=155}), sym('v_18_', nil, {filename=nil, line=155})}, getmetatable(list())), kv_expr}, {filename=nil, line=155}), setmetatable({filename=nil, line=156, bytestart=5677, sym('if', nil, {quoted=true, filename=nil, line=156}), setmetatable({filename=nil, line=156, bytestart=5681, sym('and', nil, {quoted=true, filename=nil, line=156}), setmetatable({filename=nil, line=156, bytestart=5686, sym('not=', nil, {quoted=true, filename=nil, line=156}), sym('k_17_', nil, {filename=nil, line=156}), sym('nil', nil, {quoted=true, filename=nil, line=156})}, getmetatable(list())), setmetatable({filename=nil, line=156, bytestart=5700, sym('not=', nil, {quoted=true, filename=nil, line=156}), sym('v_18_', nil, {filename=nil, line=156}), sym('nil', nil, {quoted=true, filename=nil, line=156})}, getmetatable(list()))}, getmetatable(list())), setmetatable({filename=nil, line=157, bytestart=5728, sym('tset', nil, {quoted=true, filename=nil, line=157}), sym('tbl_16_', nil, {filename=nil, line=157}), sym('k_17_', nil, {filename=nil, line=157}), sym('v_18_', nil, {filename=nil, line=157})}, getmetatable(list()))}, getmetatable(list()))}, getmetatable(list()))}, getmetatable(list())), sym('tbl_16_', nil, {filename=nil, line=158})}, getmetatable(list()))
  end
  ...
  local function seq_collect(how, iter_tbl, value_expr, ...)
    ...
    if has_into_3f then
      return setmetatable({filename=nil, line=170, bytestart=6252, sym('let', nil, {quoted=true, filename=nil, line=170}), setmetatable({sym('tbl_19_', nil, {filename=nil, line=170}), into}, {filename=nil, line=170}), setmetatable({filename=nil, line=171, bytestart=6281, how, iter, setmetatable({filename=nil, line=171, bytestart=6293, sym('let', nil, {quoted=true, filename=nil, line=171}), setmetatable({sym('val_20_', nil, {filename=nil, line=171}), value_expr}, {filename=nil, line=171}), setmetatable({filename=nil, line=172, bytestart=6342, sym('table.insert', nil, {quoted=true, filename=nil, line=172}), sym('tbl_19_', nil, {filename=nil, line=172}), sym('val_20_', nil, {filename=nil, line=172})}, getmetatable(list()))}, getmetatable(list()))}, getmetatable(list())), sym('tbl_19_', nil, {filename=nil, line=173})}, getmetatable(list()))
    else
      return setmetatable({filename=nil, line=177, bytestart=6618, sym('let', nil, {quoted=true, filename=nil, line=177}), setmetatable({sym('tbl_21_', nil, {filename=nil, line=177}), setmetatable({}, {filename=nil, line=177})}, {filename=nil, line=177}), setmetatable({filename=nil, line=178, bytestart=6644, sym('var', nil, {quoted=true, filename=nil, line=178}), sym('i_22_', nil, {filename=nil, line=178}), 0}, getmetatable(list())), setmetatable({filename=nil, line=179, bytestart=6666, how, iter, setmetatable({filename=nil, line=180, bytestart=6695, sym('let', nil, {quoted=true, filename=nil, line=180}), setmetatable({sym('val_23_', nil, {filename=nil, line=180}), value_expr}, {filename=nil, line=180}), setmetatable({filename=nil, line=181, bytestart=6738, sym('when', nil, {quoted=true, filename=nil, line=181}), setmetatable({filename=nil, line=181, bytestart=6744, sym('not=', nil, {quoted=true, filename=nil, line=181}), sym('nil', nil, {quoted=true, filename=nil, line=181}), sym('val_23_', nil, {filename=nil, line=181})}, getmetatable(list())), setmetatable({filename=nil, line=182, bytestart=6781, sym('set', nil, {quoted=true, filename=nil, line=182}), sym('i_22_', nil, {filename=nil, line=182}), setmetatable({filename=nil, line=182, bytestart=6789, sym('+', nil, {quoted=true, filename=nil, line=182}), sym('i_22_', nil, {filename=nil, line=182}), 1}, getmetatable(list()))}, getmetatable(list())), setmetatable({filename=nil, line=183, bytestart=6820, sym('tset', nil, {quoted=true, filename=nil, line=183}), sym('tbl_21_', nil, {filename=nil, line=183}), sym('i_22_', nil, {filename=nil, line=183}), sym('val_23_', nil, {filename=nil, line=183})}, getmetatable(list()))}, getmetatable(list()))}, getmetatable(list()))}, getmetatable(list())), sym('tbl_21_', nil, {filename=nil, line=184})}, getmetatable(list()))
    end
  end
  ...
  local function icollect_2a(iter_tbl, value_expr, ...)
    assert((_G["sequence?"](iter_tbl) and (2 <= #iter_tbl)), "expected iterator binding table")
    return seq_collect(sym('each', nil, {quoted=true, filename=nil, line=203}), iter_tbl, value_expr, ...)
  end
  ...
  local function fcollect_2a(iter_tbl, value_expr, ...)
    ...
    return seq_collect(sym('for', nil, {quoted=true, filename=nil, line=222}), iter_tbl, value_expr, ...)
  end
  ...
  local function accumulate_impl(for_3f, iter_tbl, body, ...)
    ...
    return setmetatable({filename=nil, line=232, bytestart=8695, sym('do', nil, {quoted=true, filename=nil, line=232}), setmetatable({filename=nil, line=233, bytestart=8706, sym('var', nil, {quoted=true, filename=nil, line=233}), accum_var, accum_init}, getmetatable(list())), setmetatable({filename=nil, line=234, bytestart=8742, iter, {unpack(iter_tbl, 3)}, setmetatable({filename=nil, line=235, bytestart=8786, sym('set', nil, {quoted=true, filename=nil, line=235}), accum_var, body}, getmetatable(list()))}, getmetatable(list())), _27_(...)}, getmetatable(list()))
  end
  ...
  local function partial_2a(f, ...)
    ...
    if (nil == bindings[1]) then
      return setmetatable({filename=nil, line=280, bytestart=10477, sym('fn', nil, {quoted=true, filename=nil, line=280}), setmetatable({_VARARG}, {filename=nil, line=280}), body}, getmetatable(list()))
    else
      return setmetatable({filename=nil, line=281, bytestart=10510, sym('let', nil, {quoted=true, filename=nil, line=281}), bindings, setmetatable({filename=nil, line=282, bytestart=10538, sym('fn', nil, {quoted=true, filename=nil, line=282}), setmetatable({_VARARG}, {filename=nil, line=282}), body}, getmetatable(list()))}, getmetatable(list()))
    end
  end
  ...
  local function pick_args_2a(n, f)
    ...
    return setmetatable({filename=nil, line=291, bytestart=10877, sym('fn', nil, {quoted=true, filename=nil, line=291}), bindings, setmetatable({filename=nil, line=291, bytestart=10891, f, unpack(bindings)}, getmetatable(list()))}, getmetatable(list()))
  end
  ...
  local function lambda_2a(...)
    ...
    local function check_21(a)
      if _G["table?"](a) then
        ...
        do
          local as = tostring(a)
          _33_ = (not as:find("^?") and (as ~= "&") and not as:find("^_") and (as ~= "...") and (as ~= "&as"))
        end
        if _33_ then
          return table.insert(args, check_position, setmetatable({filename=nil, line=312, bytestart=11837, sym('_G.assert', nil, {quoted=true, filename=nil, line=312}), setmetatable({filename=nil, line=312, bytestart=11848, sym('not=', nil, {quoted=true, filename=nil, line=312}), sym('nil', nil, {quoted=true, filename=nil, line=312}), a}, getmetatable(list())), ("Missing argument %s on %s:%s"):format(tostring(a), (a.filename or "unknown"), (a.line or "?"))}, getmetatable(list())))
        end
      end
    end
    ...
    return setmetatable({filename=nil, line=321, bytestart=12282, sym('fn', nil, {quoted=true, filename=nil, line=321}), unpack(args)}, getmetatable(list()))
  end
  ...
  local function macro_2a(name, ...)
    ...
    local args = {...}
    return setmetatable({filename=nil, line=327, bytestart=12434, sym('macros', nil, {quoted=true, filename=nil, line=327}), setmetatable({[tostring(name)]=setmetatable({filename=nil, line=327, bytestart=12460, sym('fn', nil, {quoted=true, filename=nil, line=327}), unpack(args)}, getmetatable(list()))}, {filename=nil, line=327})}, getmetatable(list()))
  end
  ...
  local function macrodebug_2a(form, return_3f)
    local handle = nil
    if return_3f then
      handle = sym('do', nil, {quoted=true, filename=nil, line=332})
    else
      handle = sym('print', nil, {quoted=true, filename=nil, line=332})
    end
    return setmetatable({filename=nil, line=335, bytestart=12856, handle, view(macroexpand(form, _SCOPE), {["detect-cycles?"] = false})}, getmetatable(list()))
  end
  ...
  local function import_macros_2a(binding1, module_name1, ...)
    ...
    for i = 1, select("#", binding1, module_name1, ...), 2 do
      ...
      local expr = setmetatable({filename=nil, line=354, bytestart=14017, sym('import-macros', nil, {quoted=true, filename=nil, line=354}), modname}, getmetatable(list()))
      local filename = nil
  ...
  local function assert_repl_2a(condition, ...)
    ...
    return setmetatable({filename=nil, line=379, bytestart=15238, sym('let', nil, {quoted=true, filename=nil, line=379}), setmetatable({sym('unpack_44_', nil, {filename=nil, line=379}), setmetatable({filename=nil, line=379, bytestart=15252, sym('or', nil, {quoted=true, filename=nil, line=379}), sym('table.unpack', nil, {quoted=true, filename=nil, line=379}), sym('_G.unpack', nil, {quoted=true, filename=nil, line=379})}, getmetatable(list())), sym('pack_46_', nil, {filename=nil, line=380}), setmetatable({filename=nil, line=380, bytestart=15295, sym('or', nil, {quoted=true, filename=nil, line=380}), sym('table.pack', nil, {quoted=true, filename=nil, line=380}), setmetatable({filename=nil, line=nil, bytestart=nil, sym('hashfn', nil, {quoted=true, filename=nil, line=nil}), setmetatable({filename=nil, line=380, bytestart=15311, sym('doto', nil, {quoted=true, filename=nil, line=380}), setmetatable({sym('$...', nil, {quoted=true, filename=nil, line=380})}, {filename=nil, line=380}), setmetatable({filename=nil, line=380, bytestart=15324, sym('tset', nil, {quoted=true, filename=nil, line=380}), "n", setmetatable({filename=nil, line=380, bytestart=15333, sym('select', nil, {quoted=true, filename=nil, line=380}), "#", sym('$...', nil, {quoted=true, filename=nil, line=380})}, getmetatable(list()))}, getmetatable(list()))}, getmetatable(list()))}, getmetatable(list()))}, getmetatable(list())), sym('vals_45_', nil, {filename=nil, line=383}), setmetatable({filename=nil, line=383, bytestart=15506, sym('pack_46_', nil, {filename=nil, line=383}), condition, ...}, getmetatable(list())), sym('condition_47_', nil, {filename=nil, line=384}), setmetatable({filename=nil, line=384, bytestart=15550, sym('.', nil, {quoted=true, filename=nil, line=384}), sym('vals_45_', nil, {filename=nil, line=384}), 1}, getmetatable(list())), sym('message_48_', nil, {filename=nil, line=385}), setmetatable({filename=nil, line=385, bytestart=15580, sym('or', nil, {quoted=true, filename=nil, line=385}), setmetatable({filename=nil, line=385, bytestart=15584, sym('.', nil, {quoted=true, filename=nil, line=385}), sym('vals_45_', nil, {filename=nil, line=385}), 2}, getmetatable(list())), "assertion failed, entering repl."}, getmetatable(list()))}, {filename=nil, line=379}), setmetatable({filename=nil, line=386, bytestart=15638, sym('if', nil, {quoted=true, filename=nil, line=386}), setmetatable({filename=nil, line=386, bytestart=15642, sym('not', nil, {quoted=true, filename=nil, line=386}), sym('condition_47_', nil, {filename=nil, line=386})}, getmetatable(list())), setmetatable({filename=nil, line=387, bytestart=15668, sym('let', nil, {quoted=true, filename=nil, line=387}), setmetatable({sym('opts_49_', nil, {filename=nil, line=387}), setmetatable({["assert-repl?"]=true}, {filename=nil, line=387}), sym('fennel_50_', nil, {filename=nil, line=388}), setmetatable({filename=nil, line=388, bytestart=15724, sym('require', nil, {quoted=true, filename=nil, line=388}), _G["fennel-module-name"]()}, getmetatable(list())), sym('locals_51_', nil, {filename=nil, line=389}), add_locals(_G["get-scope"](), {})}, {filename=nil, line=387}), setmetatable({filename=nil, line=390, bytestart=15820, sym('set', nil, {quoted=true, filename=nil, line=390}), sym('opts_49_.message', nil, {filename=nil, line=390}), setmetatable({filename=nil, line=390, bytestart=15839, sym('fennel_50_.traceback', nil, {filename=nil, line=390}), sym('message_48_', nil, {filename=nil, line=390})}, getmetatable(list()))}, getmetatable(list())), setmetatable({filename=nil, line=391, bytestart=15880, sym('each', nil, {quoted=true, filename=nil, line=391}), setmetatable({sym('k_52_', nil, {filename=nil, line=391}), sym('v_53_', nil, {filename=nil, line=391}), setmetatable({filename=nil, line=391, bytestart=15893, sym('pairs', nil, {quoted=true, filename=nil, line=391}), sym('_G', nil, {quoted=true, filename=nil, line=391})}, getmetatable(list()))}, {filename=nil, line=391}), setmetatable({filename=nil, line=392, bytestart=15918, sym('when', nil, {quoted=true, filename=nil, line=392}), setmetatable({filename=nil, line=392, bytestart=15924, sym('=', nil, {quoted=true, filename=nil, line=392}), sym('nil', nil, {quoted=true, filename=nil, line=392}), setmetatable({filename=nil, line=392, bytestart=15931, sym('.', nil, {quoted=true, filename=nil, line=392}), sym('locals_51_', nil, {filename=nil, line=392}), sym('k_52_', nil, {filename=nil, line=392})}, getmetatable(list()))}, getmetatable(list())), setmetatable({filename=nil, line=392, bytestart=15947, sym('tset', nil, {quoted=true, filename=nil, line=392}), sym('locals_51_', nil, {filename=nil, line=392}), sym('k_52_', nil, {filename=nil, line=392}), sym('v_53_', nil, {filename=nil, line=392})}, getmetatable(list()))}, getmetatable(list()))}, getmetatable(list())), setmetatable({filename=nil, line=393, bytestart=15981, sym('set', nil, {quoted=true, filename=nil, line=393}), sym('opts_49_.env', nil, {filename=nil, line=393}), sym('locals_51_', nil, {filename=nil, line=393})}, getmetatable(list())), setmetatable({filename=nil, line=394, bytestart=16016, sym('_G.assert', nil, {quoted=true, filename=nil, line=394}), setmetatable({filename=nil, line=394, bytestart=16027, sym('fennel_50_.repl', nil, {filename=nil, line=394}), sym('opts_49_', nil, {filename=nil, line=394})}, getmetatable(list()))}, getmetatable(list()))}, getmetatable(list())), setmetatable({filename=nil, line=395, bytestart=16059, sym('values', nil, {quoted=true, filename=nil, line=395}), setmetatable({filename=nil, line=395, bytestart=16067, sym('unpack_44_', nil, {filename=nil, line=395}), sym('vals_45_', nil, {filename=nil, line=395}), 1, sym('vals_45_.n', nil, {filename=nil, line=395})}, getmetatable(list()))}, getmetatable(list()))}, getmetatable(list()))}, getmetatable(list()))
  end
  ...
  load_macros([===[local function copy0(t)
    local tbl_14_ = {}
    for k, v in pairs(t) do
      local k_15_, v_16_ = k, v
      if ((k_15_ ~= nil) and (v_16_ ~= nil)) then
  ...
  utils['fennel-module'].metadata:setall(copy0, "fnl/arglist", {"t"})
  ...
  local function case_values(vals, pattern, unifications, case_pattern, opts)
    local condition = setmetatable({filename=nil, line=20, bytestart=528, sym('and', nil, {quoted=true, filename=nil, line=20})}, getmetatable(list()))
    local bindings = {}
  ...
  local function case_table(val, pattern, unifications, case_pattern, opts, _3ftop)
    ...
    if ("table" == _3ftop) then
      condition = setmetatable({filename=nil, line=30, bytestart=1005, sym('and', nil, {quoted=true, filename=nil, line=30})}, getmetatable(list()))
    else
      condition = setmetatable({filename=nil, line=30, bytestart=1012, sym('and', nil, {quoted=true, filename=nil, line=30}), setmetatable({filename=nil, line=30, bytestart=1017, sym('=', nil, {quoted=true, filename=nil, line=30}), setmetatable({filename=nil, line=30, bytestart=1020, sym('_G.type', nil, {quoted=true, filename=nil, line=30}), val}, getmetatable(list())), "table"}, getmetatable(list()))}, getmetatable(list()))
    end
    local bindings = {}
    for k, pat in pairs(pattern) do
      if _G["sym?"](pat, "&") then
        local rest_pat = pattern[(k + 1)]
        local rest_val = setmetatable({filename=nil, line=35, bytestart=1195, sym('select', nil, {quoted=true, filename=nil, line=35}), k, setmetatable({filename=nil, line=35, bytestart=1206, setmetatable({filename=nil, line=35, bytestart=1207, sym('or', nil, {quoted=true, filename=nil, line=35}), sym('table.unpack', nil, {quoted=true, filename=nil, line=35}), sym('_G.unpack', nil, {quoted=true, filename=nil, line=35})}, getmetatable(list())), val}, getmetatable(list()))}, getmetatable(list()))
        local subcondition = case_table(setmetatable({filename=nil, line=36, bytestart=1284, sym('pick-values', nil, {quoted=true, filename=nil, line=36}), 1, rest_val}, getmetatable(list())), rest_pat, unifications, case_pattern, without(opts, "multival?"))
      ...
      elseif (("number" ~= type(k)) or (not _G["sym?"](pattern[(k - 1)], "&as") and not _G["sym?"](pattern[(k - 1)], "&"))) then
        local subval = setmetatable({filename=nil, line=58, bytestart=2418, sym('.', nil, {quoted=true, filename=nil, line=58}), val, k}, getmetatable(list()))
  ...
  local function case_guard(vals, condition, guards, unifications, case_pattern, opts)
    if guards[1] then
      ...
      local condition0 = setmetatable({filename=nil, line=69, bytestart=3002, sym('and', nil, {quoted=true, filename=nil, line=69}), unpack(guards)}, getmetatable(list()))
      return setmetatable({filename=nil, line=70, bytestart=3042, sym('and', nil, {quoted=true, filename=nil, line=70}), pcondition, setmetatable({filename=nil, line=71, bytestart=3080, sym('let', nil, {quoted=true, filename=nil, line=71}), bindings, condition0}, getmetatable(list()))}, getmetatable(list())), bindings
    else
  ...
  local function case_or(vals, pattern, guards, unifications, case_pattern, opts)
    ...
    if (nil == bindings[1]) then
      local condition = nil
      do
        local tbl_17_ = setmetatable({filename=nil, line=125, bytestart=5354, sym('or', nil, {quoted=true, filename=nil, line=125})}, getmetatable(list()))
        local i_18_ = #tbl_17_
      ...
      local _74_
      if guards[1] then
        _74_ = setmetatable({filename=nil, line=128, bytestart=5495, sym('and', nil, {quoted=true, filename=nil, line=128}), condition, unpack(guards)}, getmetatable(list()))
      else
        _74_ = condition
      end
      return _74_, {}
      ...
      local pre_bindings = setmetatable({filename=nil, line=135, bytestart=5870, sym('if', nil, {quoted=true, filename=nil, line=135})}, getmetatable(list()))
      for _, subpattern in ipairs(pattern0) do
        local subcondition, subbindings = case_guard(vals, subpattern, guards, {}, case_pattern, opts)
        table.insert(pre_bindings, subcondition)
        table.insert(pre_bindings, setmetatable({filename=nil, line=139, bytestart=6116, sym('let', nil, {quoted=true, filename=nil, line=139}), subbindings, setmetatable({filename=nil, line=140, bytestart=6176, sym('values', nil, {quoted=true, filename=nil, line=140}), true, unpack(bindings)}, getmetatable(list()))}, getmetatable(list())))
      end
      return matched_3f, {setmetatable({filename=nil, line=142, bytestart=6256, unpack(bindings)}, getmetatable(list())), setmetatable({filename=nil, line=142, bytestart=6278, sym('values', nil, {quoted=true, filename=nil, line=142}), unpack(bindings_mangled)}, getmetatable(list()))}, {setmetatable({filename=nil, line=143, bytestart=6333, matched_3f, unpack(bindings_mangled)}, getmetatable(list())), pre_bindings}
    end
  end
  ...
  local function case_pattern(vals, pattern, unifications, opts, _3ftop)
    ...
    if (_G["sym?"](pattern) and (_G["sym?"](pattern, "nil") or (opts["infer-unification?"] and _G["in-scope?"](pattern) and not _G["sym?"](pattern, "_")) or (opts["infer-unification?"] and _G["multi-sym?"](pattern) and _G["in-scope?"](_G["multi-sym?"](pattern)[1])))) then
      return setmetatable({filename=nil, line=177, bytestart=8254, sym('=', nil, {quoted=true, filename=nil, line=177}), val, pattern}, getmetatable(list())), {}
    elseif (_G["sym?"](pattern) and unifications[tostring(pattern)]) then
      return setmetatable({filename=nil, line=180, bytestart=8402, sym('=', nil, {quoted=true, filename=nil, line=180}), unifications[tostring(pattern)], val}, getmetatable(list())), {}
    elseif _G["sym?"](pattern) then
      ...
      if (wildcard_3f or string.find(tostring(pattern), "^?")) then
        ...
        _80_ = setmetatable({filename=nil, line=186, bytestart=8741, sym('not=', nil, {quoted=true, filename=nil, line=186}), sym("nil"), val}, getmetatable(list()))
      end
      return _80_, {pattern, val}
    elseif (_G["list?"](pattern) and _G["sym?"](pattern[1], "=") and _G["sym?"](pattern[2])) then
      ...
      return setmetatable({filename=nil, line=196, bytestart=9355, sym('=', nil, {quoted=true, filename=nil, line=196}), val, bind}, getmetatable(list())), {}
    ...
    elseif (type(pattern) == "table") then
      ...
      return setmetatable({filename=nil, line=228, bytestart=11092, sym('=', nil, {quoted=true, filename=nil, line=228}), val, pattern}, getmetatable(list())), {}
    end
  end
  ...
  local function add_pre_bindings(out, pre_bindings)
    if pre_bindings then
      local tail = setmetatable({filename=nil, line=237, bytestart=11490, sym('if', nil, {quoted=true, filename=nil, line=237})}, getmetatable(list()))
      table.insert(out, true)
      table.insert(out, setmetatable({filename=nil, line=239, bytestart=11555, sym('let', nil, {quoted=true, filename=nil, line=239}), pre_bindings, tail}, getmetatable(list())))
      return tail
    else
      return out
    end
  ...
  local function case_condition(vals, clauses, match_3f, top_table_3f)
    local root = setmetatable({filename=nil, line=248, bytestart=11896, sym('if', nil, {quoted=true, filename=nil, line=248})}, getmetatable(list()))
    do
      local out = root
      for i = 1, #clauses, 2 do
        ...
        condition, bindings, pre_bindings = case_pattern(vals, pattern, {}, {["infer-unification?"] = match_3f, ["legacy-guard-allowed?"] = match_3f, ["multival?"] = true}, _84_())
        local out0 = add_pre_bindings(out, pre_bindings)
        table.insert(out0, condition)
        table.insert(out0, setmetatable({filename=nil, line=261, bytestart=12633, sym('let', nil, {quoted=true, filename=nil, line=261}), bindings, body}, getmetatable(list())))
        out = out0
      end
    end
    return root
  ...
  local function maybe_optimize_table(val, clauses)
    ...
    do
      ...
      for i = 1, #clauses, 2 do
        ...
        all = (_G["sequence?"](clauses[i]) and _88_())
      end
      _87_ = all
    end
    if _87_ then
      ...
      return setmetatable({filename=nil, line=293, bytestart=13916, sym('values', nil, {quoted=true, filename=nil, line=293}), unpack(val)}, getmetatable(list())), _89_()
    else
      return val, clauses
    end
  end
  ...
  local function case_impl(match_3f, init_val, ...)
    ...
    if skips_multiple_eval_protection_3f then
      ...
      return list(sym('let', nil, {quoted=true, filename=nil, line=315}), {vals, val}, case_condition(vals, clauses, match_3f, _G["table?"](init_val)))
    end
  end
  ...
  local function case_try_step(how, expr, _else, pattern, body, ...)
    if ((nil == pattern) and (pattern == body)) then
      ...
      return setmetatable({filename=nil, line=346, bytestart=15867, setmetatable({filename=nil, line=346, bytestart=15868, sym('fn', nil, {quoted=true, filename=nil, line=346}), setmetatable({_VARARG}, {filename=nil, line=346}), setmetatable({filename=nil, line=347, bytestart=15888, how, _VARARG, pattern, case_try_step(how, body, _else, ...), unpack(_else)}, getmetatable(list()))}, getmetatable(list())), expr}, getmetatable(list()))
    end
  end
  ...
  local function case_try_impl(how, expr, pattern, body, ...)
    ...
    if _G["sym?"]((("table" == type(last)) and last[1]), "catch") then
      local _96_ = table.remove(clauses)
      local _ = _96_[1]
      local e = {(table.unpack or unpack)(_96_, 2)}
      catch = e
    else
      catch = {sym('__97_', nil, {filename=nil, line=357}), _VARARG}
    end
  ...
  local function case_try_2a(expr, pattern, body, ...)
    return case_try_impl(sym('case', nil, {quoted=true, filename=nil, line=375}), expr, pattern, body, ...)
  end
  ...
  local function match_try_2a(expr, pattern, body, ...)
    return case_try_impl(sym('match', nil, {quoted=true, filename=nil, line=388}), expr, pattern, body, ...)
  end
  ...
  return {["case-try"] = case_try_2a, ["match-try"] = match_try_2a, case = case_2a, match = match_2a}]===], env)
end
return mod
